  ...
  return (
    ...
    >
      <div className="flex flex-col items-center gap-[5vw] max-sm:gap-[10vw] max-md:justify-center max-sm:items-start">
        <HeadingAnim>
          <h2 className="text-76 text-[#0A1B4B] max-sm:leading-[1.4] text-center max-sm:w-full ">
      ...
      <div className="w-full mr-auto relative">
        ...
        <div className="inset-0 w-full relative">
          <div className="relative w-full h-full z-10 px-[3vw] max-sm:rounded-[2.5vw] content mix-blend-difference duration-300 max-sm:px-0">
            ...
            >
              <h3 className="text-30  text-left leading-[1.2]  max-sm:w-[70%] max-md:w-[80%] max-sm:leading-[1.5] max-sm:font-medium">
                {question}
              </h3>
              <div
              ...
              >
                <span className={`w-[1.5vw]  rounded-full h-[2px] bg-[#111111] absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 duration-300 transform-origin-center max-sm:w-[3vw] max-md:w-[3vw] max-md:h-[1.5px] max-sm:h-[1.5px] ${
                    isOpen ? "rotate-90 bg-white" : "rotate-90"
                  }`}></span>

                <span
               
                  className={`w-[1.5vw] rounded-full h-[2px] bg-[#111111] absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 duration-300 transform-origin-center max-sm:w-[3vw] max-md:w-[3vw] max-sm:h-[1.5px] ${
            ...
            <AnimatePresence initial={false}>
              {isOpen && (
                ...
                >
                  <div className="pb-[3.5vw] text-foreground text-24 w-[90%] max-sm:pb-[8vw] max-sm:w-[95%] max-sm:font-light max-sm:text-[4vw] space-y-[1vw]">
