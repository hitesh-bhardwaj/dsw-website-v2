    ...
    <div className="w-full h-full flex relative  justify-between px-[5vw] py-[7%]">
      ...
      >
        ...
        <p className=" fadeup">
         ...
         <ul className="space-y-[1vw] list-disc marker:text-sm pl-[1.5vw] py-[1vw] max-md:pl-[7vw] max-md:py-[3vw] max-md:space-y-[2vw] fadeup ">
         ...
         <p className=" fadeup">The information we collect about you. We value your trust. In order to honour that trust, Data Science Wizards adheres to ethical standards in gathering, using, and safeguarding any information you provide.</p>
        </div>

         <HeadingAnim>


<h2 className="text-44  headingAnim leading-[1.2] max-md:leading-[1.3] max-sm:leading-[1.4]" id="collect-and-process">We collect and process the following personal information from you:</h2>
         </HeadingAnim>
         <div className="space-y-[2vw] max-md:space-y-[4vw]" id="info-you-give"> 
        <h3 className="text-44 leading-[1.2] max-md:leading-[1.3] max-sm:leading-[1.4] fadeup">
      ...
      Business Transfers:
       ...
       As we develop our business, we might sell or buy businesses or assets. Your personal information may be transferred to a buyer or other successor in the event of a corporate sale, merger, reorganization, dissolution, or similar event in which personal information held by us about our Site users is among the assets transferred.
        ...
        <h2 className="text-44 leading-[1.2] max-md:leading-[1.3] max-sm:leading-[1.4] fadeup">
 ...
 <div className="space-y-[2vw] max-md:space-y-[4vw]" id="legal-requirements"> 
   <HeadingAnim>
     ...
     We use the following types of cookies:
        ...
        <ul className=" fadeup space-y-[1vw] list-disc marker:text-sm pl-[1.5vw] py-[1vw] max-md:pl-[7vw] max-md:py-[3vw] max-md:space-y-[2vw]">
        ...
        <p className=" fadeup"> We may also work with marketing and advertising networks that gather information about the content on our Site you visit and on information on other websites and services you visit. This may result in you seeing advertisements on our Site or our advertisements when you visit other websites and services of third parties.</p>
        </div>
      ...
      For Microsoft Internet Explorer:
        ...
        <ul className=" fadeup space-y-[1vw] list-decimal pl-[1.5vw] py-[1vw] max-md:pl-[7vw] max-md:py-[3vw] max-md:space-y-[2vw]">
      ...
      For Opera 6.0 and further:
        ...
        <p className=" fadeup">Where you have not set your permissions, we may also separately prompt you regarding our use of cookies on our Site. Except for essential cookies, all cookies used on our Site will expire after two years.</p>
        </div>
