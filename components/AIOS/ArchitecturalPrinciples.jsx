            ...
            >
              <div
                className={`w-[47%] p-[2vw] bg-white transition-all duration-700 max-sm:w-full max-sm:p-[5vw] max-sm:m-0 max-sm:ml-[5%] ${
                  principle.side === "right"
                    ? "border-l-4 border-[#c1c1c1] ml-[5%] [.active>&]:border-primary-blue"
                    : "border-r-4 border-[#c1c1c1] mr-[5%] text-left [.active>&]:border-primary-blue max-sm:border-r-0 max-sm:border-l-4 max-sm:text-left max-sm:mr-0"
                }`}
              >
