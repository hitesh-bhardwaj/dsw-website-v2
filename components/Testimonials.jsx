...
export default function Testimonials() {
  return (
    <section className="relative w-full pb-[7%] px-[3.91vw] space-y-[8vw] max-md:space-y-[10vw] max-md:px-[6vw] max-sm:px-[7vw] max-sm:py-[15%] max-sm:space-y-[15vw]">
      {/* Heading */}
      <div className="text-center w-[45%] max-md:w-[80%] max-sm:w-full mx-auto space-y-[2vw] max-md:space-y-[5vw] max-sm:space-y-[7vw]">
        <HeadingAnim>
        ...
        {TESTIMONIALS.map((item, i) => {
          ...
          if (item.type === "stat") {
            return (
              <div
                key={i}
                className="bg-white border-[0.078vw] border-primary-blue rounded-[1.3vw] p-[1.48vw] max-md:px-[2.3vw] h-[17.71vw] max-md:h-[32vw] flex items-end max-md:items-center max-sm:p-[5vw] max-sm:h-[60vw] max-sm:rounded-[4vw]"
              >
          ...
          if (item.type === "image") {
            return (
              <div
                key={i}
                className="bg-[#030a25] border-[0.078vw] border-primary-blue max-md:h-[32vw] rounded-[1.3vw] overflow-hidden h-[17.71vw] relative group transition-all duration-500 ease-out max-sm:h-[60vw] max-sm:rounded-[4vw]"
              >
                <Image
                  src={item.src}
                  alt={item.alt}
          ...
          return (
            <div
              key={i}
              className="bg-white border-[0.078vw] border-primary-blue rounded-[1.3vw] py-[1.5vw] max-md:p-[2.5vw] max-md:px-[2vw] px-[1.5vw] h-[17.71vw] flex flex-col justify-between max-md:h-[32vw] max-sm:p-[5vw] max-sm:h-[70vw] max-sm:rounded-[4vw]"
            >
