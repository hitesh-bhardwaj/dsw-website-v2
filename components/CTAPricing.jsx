...
const Background = () => {
    ...
    useEffect(() => {
        ...
        // Animate currency groups
        const groups = [
            { selector: '#right-center-group', path: '#path-right-center', direction: 'ltr' },
            { selector: '#right-top-group', path: '#path-right-top', direction: 'ltr' },
            { selector: '#right-bottom-group', path: '#path-right-bottom', direction: 'rtl' },
            { selector: '#left-top-group', path: '#path-left-top', direction: 'ltr' },
            { selector: '#left-bottom-group', path: '#path-left-bottom', direction: 'rtl' },
            { selector: '#left-center-group', path: '#path-left-center', direction: 'ltr' },
        ...
        function animateGroup({ selector, path, direction }) {
            if (!running) return;
            const duration = 2.5 + Math.random() * 2.5;
            const delay = 0.3 + Math.random() * 0.5;
            const initialDelay = Math.random() * 2.5;
            const start = direction === 'rtl' ? 1 : 0;
            const end = direction === 'rtl' ? 0 : 1;
            gsap.set(selector, {
                opacity: 0,
                motionPath: {
                    path,
            ...
            tl.to(selector, {
                ...
                .add(() => {
                    setTimeout(() => {
                        animateGroup({ selector, path, direction });
                    }, delay * 1000);
                });
            tls.push(tl);
        }
        groups.forEach(group => animateGroup(group));

        // Animate gradient elements
       const gradientItems = [
  // left-center
  { sel: 'svg path[fill="url(#paint0_linear_7_2)"]', path: '#path-left-center', start: 0, end: 1 },
  { sel: 'svg path[fill="url(#paint1_linear_7_2)"]', path: '#path-left-center', start: 0, end: 1 },

  // right-top (path is drawn right->center, so 0->1 goes right->center)
  { sel: 'svg path[fill="url(#paint2_linear_7_2)"]', path: '#path-right-top', start: 0, end: 1 },
  { sel: 'svg path[fill="url(#paint3_linear_7_2)"]', path: '#path-right-top', start: 0, end: 1 },

  // right-center
  { sel: 'svg path[fill="url(#paint4_linear_7_2)"]', path: '#path-right-center', start: 0, end: 1 },
  { sel: 'svg path[fill="url(#paint5_linear_7_2)"]', path: '#path-right-center', start: 0, end: 1 },

  // right-bottom (path is drawn center->right, so reverse to go right->center)
  { sel: 'svg path[fill="url(#paint6_linear_7_2)"]', path: '#path-right-bottom', start: 1, end: 0 },
  { sel: 'svg path[fill="url(#paint7_linear_7_2)"]', path: '#path-right-bottom', start: 1, end: 0 },

  // ✅ NEW: left-top (path is drawn left->center, so 0->1 goes left->center)
  { sel: 'svg path[fill="url(#paint8_linear_7_2)"]', path: '#path-left-top', start: 0, end: 1 }, // dot
  { sel: 'svg path[fill="url(#paint9_linear_7_2)"]', path: '#path-left-top', start: 0, end: 1 }, // bar

  // ✅ NEW: left-bottom (path is drawn center->left, so reverse to go left->center)
  { sel: 'svg path[fill="url(#paint10_linear_7_2)"]', path: '#path-left-bottom', start: 1, end: 0 }, // dot
  { sel: 'svg path[fill="url(#paint11_linear_7_2)"]', path: '#path-left-bottom', start: 1, end: 0 }, // bar
];


let gradientTls = [];

gradientItems.forEach(({ sel, path, start, end }) => {
  const duration = 2.5 + Math.random() * 2.5;
  const delay = Math.random() * 2.5;

  // lock initial position ON the path immediately (prevents “snap” after delay)
  gsap.set(sel, {
    motionPath: {
      path,
      align: path,
  ...
  gradientTls.push(tl);
    ...
    return (
       <>
       <svg ref={svgRef} className='w-full h-full' width="2444" height="679" viewBox="0 0 2444 679" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<path d="M2291.34 18.1562C2291.34 18.5263 2291.04 18.8262 2290.67 18.8262C2290.3 18.8262 2290 18.5263 2290 18.1562C2290 17.7862 2290.3 17.4862 2290.67 17.4862C2291.04 17.4862 2291.34 17.7862 2291.34 18.1562Z" fill="url(#paint2_linear_7_2)"/>
<path d="M2426.66 17.4873C2426.67 17.8762 2426.67 18.2658 2426.67 18.6562C2426.67 18.7126 2426.67 18.7689 2426.67 18.8252H2290.67C2290.67 18.7689 2290.67 19.1562 2290.67 18.6562C2290.67 18.1562 2290.67 17.8762 2290.68 17.4873H2426.66Z" fill="url(#paint3_linear_7_2)"/>
<path d="M1868.89 340.986C1868.89 341.356 1868.59 341.656 1868.22 341.656C1867.85 341.656 1867.55 341.356 1867.55 340.986C1867.55 340.616 1867.85 340.316 1868.22 340.316C1868.59 340.316 1868.89 340.616 1868.89 340.986Z" fill="url(#paint4_linear_7_2)"/>
<path d="M2004.21 340.317C2004.21 340.706 2004.22 341.096 2004.22 341.486C2004.22 341.543 2004.22 341.599 2004.22 341.655H1868.22C1868.22 341.599 1868.22 341.986 1868.22 341.486C1868.22 340.986 1868.22 340.706 1868.23 340.317H2004.21Z" fill="url(#paint5_linear_7_2)"/>
<path d="M2308.34 664.156C2308.34 664.526 2308.04 664.826 2307.67 664.826C2307.3 664.826 2307 664.526 2307 664.156C2307 663.786 2307.3 663.486 2307.67 663.486C2308.04 663.486 2308.34 663.786 2308.34 664.156Z" fill="url(#paint6_linear_7_2)"/>
<path d="M2443.66 663.487C2443.67 663.876 2443.67 664.266 2443.67 664.656C2443.67 664.713 2443.67 664.769 2443.67 664.825H2307.67C2307.67 664.769 2307.67 665.156 2307.67 664.656C2307.67 664.156 2307.67 663.876 2307.68 663.487H2443.66Z" fill="url(#paint7_linear_7_2)"/>
<defs>
...
<linearGradient id="paint2_linear_7_2" x1="2290" y1="18.2009" x2="2426.67" y2="18.2009" gradientUnits="userSpaceOnUse">
<stop offset="0.51" stopColor="#1727FF"/>
<stop offset="1" stopColor="white" stopOpacity="0"/>
</linearGradient>
<linearGradient id="paint3_linear_7_2" x1="2290" y1="18.2009" x2="2426.67" y2="18.2009" gradientUnits="userSpaceOnUse">
<stop offset="0.51" stopColor="#1727FF"/>
<stop offset="1" stopColor="white" stopOpacity="0"/>
</linearGradient>
<linearGradient id="paint4_linear_7_2" x1="1867.55" y1="341.031" x2="2004.22" y2="341.031" gradientUnits="userSpaceOnUse">
<stop offset="0.51" stopColor="#1727FF"/>
<stop offset="1" stopColor="white" stopOpacity="0"/>
</linearGradient>
<linearGradient id="paint5_linear_7_2" x1="1867.55" y1="341.031" x2="2004.22" y2="341.031" gradientUnits="userSpaceOnUse">
<stop offset="0.51" stopColor="#1727FF"/>
<stop offset="1" stopColor="white" stopOpacity="0"/>
</linearGradient>
<linearGradient id="paint6_linear_7_2" x1="2307" y1="664.201" x2="2443.67" y2="664.201" gradientUnits="userSpaceOnUse">
<stop offset="0.51" stopColor="#1727FF"/>
<stop offset="1" stopColor="white" stopOpacity="0"/>
</linearGradient>
<linearGradient id="paint7_linear_7_2" x1="2307" y1="664.201" x2="2443.67" y2="664.201" gradientUnits="userSpaceOnUse">
<stop offset="0.51" stopColor="#1727FF"/>
<stop offset="1" stopColor="white" stopOpacity="0"/>
</linearGradient>
</defs>
