...
function AboutCard({ challenge }) {
    return (
        <div className="relative fadeup max-sm:w-full max-md:w-[48%] ">
            <div
                className={`
                    relative bg-white  hover:border-primary-blue group hover:shadow-lg hover:drop-shadow-lg duration-300 ease-in-out group 
                    w-[21.5vw] h-[17vw] px-[1.5vw] py-[1.5vw] max-sm:px-[6vw] max-sm:py-[6vw] max-md:w-full max-sm:pr-[12vw] max-sm:h-[54vw] border
                    border-border-color flex flex-col justify-start gap-[3vw] max-sm:gap-[8vw] max-sm:justify-between  max-md:h-[35vw] max-md:p-[4vw]
                `}
            >
                <CornerDecorations />
                <CornerDecorations />
                <div className=" w-[5vw] h-[5vw] max-sm:h-[15vw] max-sm:w-[15vw]  text-primary-blue max-md:size-[10vw]">
...
export default function UnifyAbout() {
    ...
    return (
        <section className="relative w-full pt-[15%] pb-[2%] px-[5vw] max-sm:py-[15%] max-sm:space-y-[15vw] space-y-[7vw] max-md:space-y-[10vw]">
            ...
            <div className="flex justify-between  max-md:w-full max-sm:mx-auto max-sm:flex-col  space-y-[6vw] max-sm:space-y-[10vw] max-md:flex-wrap">
