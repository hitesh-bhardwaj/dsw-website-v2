    ...
    return (
        <section className="relative w-full py-[7%] pt-[10%] max-sm:px-[7vw] max-sm:py-[20%] space-y-[8vw] max-sm:space-y-[24vw] z-[2]">
            <div className="text-center mx-auto space-y-[2vw] max-sm:w-full max-sm:space-y-[7vw]">
                ...
                <Copy>
                    <p className="text-30 w-[70%] font-sans leading-[1.4] text-foreground mx-auto">
                ...
                <Copy>
                    <p className="text-30 w-[60%] font-sans font-medium leading-[1.4] text-foreground mx-auto">
