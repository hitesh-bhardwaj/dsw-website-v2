...
const JoinUs = () => {
    return (
        <section className="relative w-full h-fit py-[7%] pt-[10%] px-[5vw] pb-[3%] max-sm:px-0 max-sm:py-[15%] max-sm:pb-[15%] max-sm:h-fit max-md:py-[10%] max-md:overflow-hidden">
            {/* Heading Section */}
            <div className="space-y-[5.5vw]  h-fit max-sm:static max-sm: max-sm:space-y-[12vw] z-10">
                ...
                <div className="hidden max-sm:block w-full overflow-x-auto overflow-y-visible fadeup mobile-scrollbar pb-6  px-[7vw]">
