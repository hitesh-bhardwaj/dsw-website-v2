...
const TeamWrapper = () => {
  return (
    <section className="relative w-full h-fit py-0 px-[5vw] max-sm:px-0  max-sm:py-[15%] max-sm:h-fit">
      {/* Heading Section */}
      <div className="space-y-[5.5vw] h-fit max-sm:static w-screen overflow-hidden ml-[-5vw] px-[5vw] max-sm:ml-0 max-sm:space-y-[12vw] max-md:space-y-[7vw] z-10">
        <div className="text-center space-y-[2vw] max-sm:space-y-[7vw] max-md:space-y-[4vw]">
          <HeadingAnim>
          ...
          <Copy>
            <p className="text-24 font-sans leading-[1.4] text-foreground w-[55%] max-sm:w-full mx-auto max-md:w-[80%]">
              DSW is a team of engineers, data scientists, product builders, and
              enterprise operators - building the infrastructure layer that
              makes AI real in the enterprise.
            </p>
          </Copy>
        </div>

        <div className="space-y-[7vw] max-sm:space-y-[15vw]">
          <Team
            heading={"Founding Team"}
            cardsData={foundingTeam}
            teamId="founding"
          />
          <Team
            heading={"Growth Team"}
            cardsData={growthTeam}
            teamId="growth"
          />
