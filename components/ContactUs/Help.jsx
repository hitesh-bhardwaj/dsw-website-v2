    ...
    >
      ...
      <div className="flex flex-wrap fadeup justify-center gap-[3vw] items-center w-full max-md:gap-[4vw] max-sm:gap-[8vw] pt-[5vw] max-md:flex-col max-md:pt-0">
        {helpCards.map((card) => (
          <div
            key={card.id}
            className=" w-[48%] p-[3vw] py-[3.5vw] bg-white max-md:h-full max-md:w-full!  max-md:justify-between max-md:px-[7vw] max-md:py-[8vw] relative border border-[#C2C2C2] group/corner hover:shadow-lg hover:drop-shadow-lg transition-all duration-300 hover:border-primary-blue ease-in-out"
          >
            <CornerDecorations />
