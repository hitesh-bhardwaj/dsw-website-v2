...
const challenges = [
 ...
 function CornerDecorations({
  ...
  return (
    <>
      {/* Top Left */}
      <div className="absolute -top-[0.25%] -left-[0.15%] w-fit h-fit group-hover:-top-[3%] group-hover:-left-[3%] duration-300 ease-in-out">
      ...
      {/* Bottom Left */}
      <div className="absolute bottom-[0.5%] -left-[0.6%] w-fit h-fit -rotate-90 group-hover:-bottom-[2.2%] group-hover:-left-[4.5%] duration-300 ease-in-out">
        <div className={`${line} bg-black group-hover:bg-[#0205fa]`} />
        <div
          className={`${line} bg-black group-hover:bg-[#0205fa] rotate-90 absolute top-[2px] -left-1/2`}
        />
