  ...
  return (
    <>
      <div className=" relative group max-md:space-y-[10vw] h-fit max-md:w-full w-[49%] hover:shadow-lg hover:drop-shadow-lg transition-all duration-300 ease-in-out ">
        <CornerDecorations/>
        <div className=" py-[3vw] px-[3vw] max-sm:h-[80vw] max-sm:p-[6vw] max-sm:py-[7vw] space-y-[5vw] max-md:flex max-md:flex-col max-md:items-start max-sm:justify-between max-sm:space-y-[6vw] w-full border border-[#C2C2C2] group-hover:border-[#0205fa]">
