  ...
  return (
    <>
      <div className="relative group max-md:space-y-[10vw] h-fit max-sm:w-full w-[49%] hover:shadow-lg hover:drop-shadow-lg transition-all duration-300 ease-in-out max-md:w-full ">
        <CornerDecorations/>
        <div className=" py-[3vw] px-[3vw] max-sm:p-[6vw] max-sm:py-[7vw] h-full max-sm:h-[100vw] max-md:h-[48vw] space-y-[5vw] max-md:flex max-md:flex-col max-md:items-start max-sm:justify-between max-sm:space-y-[6vw] max-md:pb-[7vw] w-full border border-[#C2C2C2] group-hover:border-primary-blue">
  ...
  return (
    <>
      ...
      <div className="absolute -top-[0.1%] left-[0%] w-fit h-fit group-hover:-top-[3%] group-hover:-left-[3%] duration-300 ease-in-out">
        ...
        <div
          className={`${line} bg-black rotate-90 group-hover:bg-primary-blue absolute top-[2.2px] -left-1/2`}
        />
      </div>
