...
const LiveDemoDetails = ({ userName, userEmail, userDesignation, userCompany, userNumber, pageUrl }) => {
  const data = [
  ...
  return (
    <Html>
      <Head />
      <Preview>{`New live demo request from ${userName} at ${userCompany}`}</Preview>
      <Body style={main}>
        <Container style={container}>
          <Img src="https://www.datasciencewizards.ai/assets/form-logo.png" width="140" height="80" alt="DSW Logo" style={logo} />
          <Text style={paragraph}>Hi Team,</Text>
          <Text style={paragraph}>You have received a new live demo request. Please find the details below:</Text>
          ...
          <Text style={paragraph}>Please reach out to them within 24–48 hours.</Text>
...
export default LiveDemoDetails;
