// components/emailTemplate/LiveDemoDetails.jsx
...
const LiveDemoDetails = ({
  ...
  const previewText = `New live demo request from ${userName} at ${userCompany}`;
      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Text style={paragraph}>
            You have received a new live demo request. Please find the details below:
          </Text>
