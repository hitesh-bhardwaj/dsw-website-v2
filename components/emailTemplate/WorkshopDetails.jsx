...
const WorkshopDetails = ({ userName, userEmail, userDesignation, userCompany, userNumber, pageUrl }) => {
  const data = [
  ...
  return (
    <Html>
      <Head />
      <Preview>Someone just filled Workshop Details on DSW Website.</Preview>
      <Body style={main}>
        <Container style={container}>
          ...
          <Text style={paragraph}>We have a new workshop form submission on the DSW website.<br />Below are the details.</Text>
          ...
          <Hr style={hr} />
          <Text style={footer}>This form is submitted from the page - <Link href={pageUrl} style={linkStyle}>{pageUrl}</Link></Text>
