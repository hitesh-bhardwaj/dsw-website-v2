  ...
  return (
    <>
            ...
            >
              ...
              >
                ...
                <div className="w-full h-full absolute bg-gradient-to-t from-black/80 via-transparent to-transparent z-[2] inset-0 flex justify-between items-end p-[2vw] max-sm:p-[5vw]">
                  <div className="w-[3.5vw] h-auto max-sm:w-[8vw] max-md:w-[6vw]">
                    <Image
                      alt="play-icon"
              ...
              <Copy>
                <h3 className="text-32 text-foreground mt-[1vw] max-md:h-auto max-sm:pl-[1vw] max-sm:font-medium max-sm:leading-[1.4]">
                  {video.title}
                </h3>
              </Copy>
              <Copy>
                <p className="max-sm:pl-[1vw] text-24 text-foreground">
                  {truncateWords(video.description, 10)}
                </p>
              </Copy>
            </div>
          ))}
      ...
      {isMounted && openIndex !== null && (
        <div
          className={
            "fixed inset-0 z-[999] flex items-center justify-center w-screen overflow-hidden"
          }
          aria-modal="true"
          role="dialog"
        >
...
const videos = [
  {
    ...
    youtubeUrl: "https://www.youtube.com/watch?v=vknslJEBX1w",
  },
  {
  ...
  },
  {
    ...
    youtubeUrl: "https://www.youtube.com/watch?v=wK2u5B2HLYw",
  },
  {
    ...
    youtubeUrl: "https://www.youtube.com/watch?v=9XkYKR8JPms",
  },
];
