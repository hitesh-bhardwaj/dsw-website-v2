  ...
  return (
    ...
    >
      <div className="w-full h-full gap-y-[2vw] max-sm:gap-y-[6vw] max-md:gap-y-[5vw] flex flex-col items-center">
        ...
        {/* Heading */}
        <HeadingAnim>
          <h2 className="text-[#0A1B4B] text-76 leading-[1.2]  max-sm:leading-[1.3] text-center w-[80%] max-md:w-[90%] max-sm:w-full capitalize" dangerouslySetInnerHTML={{ __html:heading || "" }}/>
        </HeadingAnim>
