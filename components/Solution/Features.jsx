...
const Features = ({ featuresContent }) => {
  ...
  return (
    <section
      className="w-full py-[7%] max-md:py-[10%] max-sm:py-[15%] "
      id="features"
    >
      <div className="w-full space-y-[7vw] max-md:space-y-[10vw] h-[270vh] feature-container">
        <HeadingAnim>
        ...
        <div className="w-screen overflow-hidden fadeup sticky top-[12%] max-md:top-[25%] max-sm:top-[15%]">
          <div
            className="py-4 cursor-grab active:cursor-grabbing pr-0 pl-0 w-fit flex gap-[2vw] features-slider"
            // config={{
            //   // snap: false,
            //   infinite: false,
            //   // wheel: false,
          ...
          >
            {cards.map((card, index) => (
              ...
              >
                <div className="w-[32vw] h-[40vw] max-sm:w-[83vw] max-md:h-[70vw] max-md:w-[55vw] max-sm:h-[135vw] border-primary-blue border-t-[5px] max-md:px-[3.5vw] max-md:py-[4vw] bg-[#EFF1FB] p-[2vw] flex flex-col  cursor-grab active:cursor-grabbing gap-[4vw] max-sm:gap-[7vw] max-sm:py-[7vw] max-sm:px-[5vw]">
                  <h3 className="text-44 max-sm:leading-[1.4] max-md:min-h-[28%] max-sm:h-fit leading-[1.2] ">
                    {card.title}
                  </h3>
