        ...
        <div className="w-full h-full flex flex-wrap fadeupDelay justify-between gap-y-[7vw] max-sm:gap-y-[20vw] max-md:gap-y-[15vw]">
          {videos.map((video, index) => (
            <div key={index} className="w-[47.5%] flex flex-col gap-[1vw] max-sm:w-full max-sm:gap-[7vw] max-md:w-full max-md:gap-[4vw]">
              ...
              <Copy>
                <h3 className="text-32 mt-[1vw] max-sm:pl-[1vw]  max-sm:text-[5.5vw]">{video.title}</h3>
              </Copy>
              <Copy>
                <p className="max-sm:pl-[1vw] text-24! font-light">{video.description}</p>
              </Copy>
            </div>
          ))}
        </div>
...
const videos = [
  ...
  {
    image: "/assets/resources/product-videos/ai-complexity.png",
    alt: "ai-complexity",
    duration: "2.30 min",
  ...
  {
    image: "/assets/resources/product-videos/securing-ai.png",
    alt: "securing-ai",
    duration: "2 min",
  ...
  {
    image: "/assets/resources/product-videos/unify-video-5.png",
    alt: "unify-video-5",
    duration: "3 min",
    title: "AI Without Complexity – A Message from Our CTO",
    description:
  ...
  {
    image: "/assets/resources/product-videos/unify-video-6.png",
    alt: "unify-video-6",
    duration: "2.30 min",
    title: "AI Without Complexity – A Message from Our CTO",
    description:
