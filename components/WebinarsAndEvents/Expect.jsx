...
export default function Expect() {
  ...
  return (
    <section className="w-screen  relative z-10 px-[7vw] py-[7%] space-y-[8vw] max-sm:space-y-[12vw] max-sm:py-[25%]" id="expect">
      <div className="w-full flex flex-col items-center justify-center  gap-y-[7vw] max-sm:gap-y-[15vw] max-md:gap-y-[12vw] max-md:mt-0">
        ...
        <div className="flex  flex-wrap justify-start gap-y-[5vw] gap-x-[10vw] max-md:w-full max-sm:gap-[15vw] max-md:justify-center max-md:items-center max-md:gap-[7vw]">
          {POINTS.map(({ id, text,title}) => (
            <div
              key={id}
              className=" flex flex-col gap-[1.2vw] items-start about-item w-[44%] fadeup max-md:w-full max-sm:items-center max-md:items-start max-sm:gap-y-[5vw] max-md:gap-[5vw]"
            >
