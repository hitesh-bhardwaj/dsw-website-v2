...
export default function UnifiedRuntime() {
  ...
  return (
    ...
    >
      <HeadingAnim>
        <p className="text-30 text-center max-w-[60%] mx-auto max-sm:max-w-[90%] py-[1.5vw] max-sm:py-[4vw] hero-content">
          From Fragmented AI to One Governed Runtime
        </p>
        <h2 className="text-76 w-[80%] max-md:w-[90%] text-center mx-auto leading-[1.2] max-sm:leading-[1.4] max-sm:w-full">
          UnifyAI OS - Your Enterprise AI Factory
        </h2>
      </HeadingAnim>
      <div className="w-full flex justify-between max-sm:flex-col max-sm:items-center max-sm:gap-[10vw]">
        <div className="w-[30%] max-md:w-[40%]  max-sm:w-full max-sm:text-center">
          <HeadingAnim>
            <h3 className="text-56 ">Build your own AI Ecosystem</h3>
          </HeadingAnim>
        </div>
