...
const certificationsContent = {
  ...
  heading: "Built for regulated Banking environments from day one",
  subtext: "",
  footerText:
    "Supports model governance, audit workflows, and regulatory reporting expectations across banking operations.",
};
